...
numbers (D1 F1 0.8808 / ROC-AUC 0.9797, `docs/baseline_metrics.json`) stand as
published, and they still **beat every engineered-feature model** — which is the
uncomfortable headline Ch8 has to address honestly, not a staleness artefact.
